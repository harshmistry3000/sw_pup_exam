...
var = tk.StringVar() 
l = tk.Label(window, bg='darkblue', width=200, height=100, text='') 
l.pack() 
 

 
lb1 = tk.Label(window, text="First Name:", width=12, font=("Goudy Old Style", 12)) 
lb1.place(x=20, y=40) 
...
lb3 = tk.Label(window, text="Last Name:", width=12, font=("Goudy Old Style", 12)) 
lb3.place(x=20, y=70) 
...
lb5 = tk.Label(window, text="Select Gender:", width=12, font=("Goudy Old Style", 12,'bold'))  
...
lb6 = tk.Label(window, text="Languages:", width=12, font=("Goudy Old Style", 12)) 
...
lb7 = tk.Label(window, text="Email:",width=12, font=("Goudy Old Style", 12)) 
lb7.place(x=20, y=160) 
en4 = tk.Entry(window) 
en4.place(x=180, y=160) 
 
lb7 = tk.Label(window, text="Address:",width=12, font=("Goudy Old Style", 12)) 
lb7.place(x=20, y=190) 
en4 = tk.Text(window,width=30,height=5) 
en4.place(x=180, y=190) 
 
list_of_state = ("Gujrat", "Pune", "Banglore", "Mumbai") 
cv = tk.StringVar() 
drplist = tk.OptionMenu(window, cv, *list_of_state) 
drplist.config(width=15) 
cv.set("Choose State") 
lb2 = tk.Label(window, text="State", width=12, font=("Goudy Old Style", 12)) 
lb2.place(x=20, y=280) 
drplist.place(x=180, y=280) 
 
lb6 = tk.Label(window, text="Zip", width=12, font=("Goudy Old Style", 12)) 
lb6.place(x=20, y=320) 
en6 = tk.Entry(window) 
en6.place(x=180, y=320) 
 
list_of_type = ("credite card", "debite card") 
cv = tk.StringVar() 
drplist = tk.OptionMenu(window, cv, *list_of_type) 
drplist.config(width=20) 
cv.set("Choose Credit Card Type") 
lb2 = tk.Label(window, text="Credit Card Type", width=15, font=("Goudy Old Style", 15)) 
